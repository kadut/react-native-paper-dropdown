...
const DropDown = forwardRef((props, ref) => {
    ...
    return (<Menu visible={visible} onDismiss={onDismiss} theme={theme} testID={`${rootTestId}-menu`} anchor={<TouchableRipple ref={ref} onPress={showDropDown} onLayout={onLayout} accessibilityLabel={accessibilityLabel}>
        ...
        <ScrollView bounces={false} testID={`${rootTestId}-scrollview`} style={{
